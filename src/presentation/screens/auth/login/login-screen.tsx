...
export const LoginScreen = ({navigation}: Props) => {
  ...
  return (
    <I18nextProvider i18n={i18n}>
      <Layout style={{ flex: 1 }}>
        <Pressable onPress={handleLanguage} style={{ position: 'absolute', right: 0, top: 2, width: '100%', zIndex: 999, padding: 10 }}>
          <Text style={{ color: globalColors.primaryColors.primary, fontWeight: 'bold' }}>{t('change-language')}</Text>
        </Pressable>
